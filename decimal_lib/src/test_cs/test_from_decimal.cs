...
public class Example
{
  ...
  public static void print_s21_is_equal(decimal number1, int number2, int num)
  {
    number1 = number2;
    Console.WriteLine("#test s21_s21_from_int_to_decimal{0}\n", num);
    Console.WriteLine("  s21_decimal src1;\n int src");
    int[] bits1 = decimal.GetBits(number1);
    Console.WriteLine("  //src2 = {1};\n", number2);
    ...
    Console.WriteLine("  s21_from_int_to_decimal(src1, src2);\n");
